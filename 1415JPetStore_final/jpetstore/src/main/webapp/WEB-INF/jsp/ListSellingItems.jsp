...
<div align="center">
  <p>
    <font size="4"><b>My Selling Auction Items</b></font>
  </p>
  <table class="n23">
    <tr bgcolor="#CCCCCC">
      <td><b>Item ID</b></td>
      ...
      <c:forEach var="item" items="${sellingAuctionItemList}" varStatus="status">
      <tr bgcolor="#FFFF88">
        <td>
        ...
        <td>
          <b>
          	<font color="black"><c:out value="${item.highestPrice}" /></font>
          </b>
        </td>
        <td>
          <b>
        ...
        <td>
        	<b>
        	<font color="black"><c:out value="${item.endDate}" /></font>
        	</b>
        </td>
        <!-- 
        <td>
