...
<div>
	...
	<div class="categoryBox">
		<div>	
			...
			<a class="cTa" href="/jpetstore/shop/myLikeActivity.do"><div class="categortTxt">like</div></a>
	</div>
</div>
	...
	<div class="imgListCla" style="padding-left: 20%;padding-top: 5%;">
		<c:forEach var="result" items="${resultRecentList }">
			<div class="seelist">	
			<a href="/jpetstore/shop/DeletemyActivity.do?itemId=${result.itemId}"><img src="../images/X.png"/></a>
					<div>${result.name }</div>
