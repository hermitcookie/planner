  ...
  <tr>
    ...
    <td style="text-align: center; vertical-align: top">
      ...
      <table class="n25">
        ...
        <tr bgcolor="#FFFF88">
          <td colspan="7" align="right"><b>Sub Total: <%= request.getParameter("subTotal") %>
          </b><br /></td>
        </tr>
      </table>
      ...
      <br> 
      <a id="link2" href='<c:url value="/shop/newOrder.do?subTotal=${param.subTotal}"/>'>
